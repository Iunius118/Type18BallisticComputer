package com.github.iunius118.type18gunsight.client.gui;
...
public class ConfigGuiFactory implements IModGuiFactory {
    ...
    public GuiScreen createConfigGui(GuiScreen parentScreen) {
        ...
        return new GuiConfig(parentScreen, elements, Type18GunSight.MOD_ID, false, false, Type18GunSight.MOD_NAME);
    }
